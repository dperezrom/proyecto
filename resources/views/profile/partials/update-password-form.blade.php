    ...
    <form method="post" action="{{ route('password.update') }}" class="mt-6 space-y-6">
        ...
        <div x-data="{ show: true }">
            ...
            <div class="flex w-full mt-1">
                <input :type="show ? 'password' : 'text'" id="current_password" name="current_password"
                       ...
                       autocomplete="current-password" placeholder="Al menos 8 carácteres" minlength="8" required>
