<x-app-layout>
    <div class="w-full sm:flex sm:flex-wrap sm:justify-center">
        ...
        <div>
            ...
            <!-- Puntuación -->
            <div class="bg-white border m-5 p-3">
                ...
                <div>
                    @foreach ($porcentajeValoraciones as $valoracion => $porcentaje)
                        <div class="flex items-center mt-4">
                            <span class="text-sm font-medium text-blue-600 dark:text-blue-500">{{ $valoracion }}
                                estrellas</span>
                            <div class="w-2/4 h-5 mx-4 bg-gray-200 rounded dark:bg-gray-700">
                                <div class="h-5 bg-yellow-400 rounded" style="width: {{ $porcentaje }}%"></div>
                            </div>
                            <span
                                class="text-sm font-medium text-blue-600 dark:text-blue-500">{{ $porcentaje }}%</span>
                        </div>
                    @endforeach
                </div>
            </div>
