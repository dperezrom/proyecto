<x-app-layout>
    ...
    <div class=" bg-gray-200 border-gray-200 shadow rounded-md pb-5 sm:mx-5 lg:mx-20">
        ...
        <div class="text-sm bg-white dark:bg-gray-700 dark:text-white m-2 sm:m-6 p-5 text-gray-800 rounded-lg shadow-lg w-auto sm:w-96 break-words">
            ...
            <p class="mb-1"><span class="text-gray-500 dark:text-gray-400">Instrucción: </span> {{ $factura->instruccion }}</p>
            <p><span class="text-gray-500 dark:text-gray-400">Fecha factura: </span>{{ $factura->fecha->setTimeZone(new DateTimeZone('Europe/Madrid'))->format('d-m-Y H:i:s') }}</p>
        </div>
