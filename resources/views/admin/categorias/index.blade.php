                ...
                <form action="{{ route('admin.categorias') }}" method="GET">
                    ...
                    <div class="flex flex-wrap flex-row">
                        ...
                        <div class="mb-2 w-full sm:w-1/2 sm:px-2 lg:w-1/4">
                            <label for="nombre" class="text-sm font-medium text-gray-100 mr-3 w-24">
                                Nombre:
                            </label>
                    ...
                    <div class="flex justify-between mt-5">
                        <button type="submit"
                                class="text-white bg-emerald-500 hover:bg-emerald-700 focus:ring-4 focus:ring-emerald-300 font-medium rounded-md px-2 py-1 text-center">
                            <i
                                class="fa-solid fa-magnifying-glass pr-2"></i>Buscar
                        </button>
                ...
                <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400 border-separate">
                    ...
                    <tr>
                        <th scope="col" class="px-6 py-3">
                            <a href="{{ route('admin.categorias') }}?orden=nombre&{!! $link . $tOrdenNombre !!}"
                        ...
                        <th scope="col" class="px-6 py-3">
                            <a href="{{ route('admin.categorias') }}?orden=descripcion&{!! $link . $tOrdenDescripcion !!}"
                               class="flex items-center">
