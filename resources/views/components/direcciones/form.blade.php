    ...
    <div class="bg-gray-700 dark:bg-gray-700 p-2 rounded-t-md py-5 border-gray-400 border-b-4 md:p-5">
        ...
        <div class="mb-2 p-2">
            ...
            <input type="text" name="nombre" id="nombre"
                ...
                required autofocus autocomplete="nombre" placeholder="Nombre y apellido" maxlength="50" pattern="^([a-zA-ZáéíóúÁÉÍÓÚñÑ]+\s?)+"
        ...
        <div class="mb-2 p-2">
            ...
            <input type="text" name="ciudad" id="ciudad"
                class="bg-gray-50 border border-gray-300 text-gray-800 sm:text-sm rounded-md focus:ring-emerald-500 focus:border-emerald-500 w-full sm:w-96"
                required autofocus autocomplete="ciudad" placeholder="Ciudad" maxlength="50" pattern="^([a-zA-ZáéíóúÁÉÍÓÚñÑ]+\s?)+"
        ...
        <div class="mb-2 p-2">
            ...
            <input type="text" name="provincia" id="provincia"
                class="bg-gray-50 border border-gray-300 text-gray-800 sm:text-sm rounded-md focus:ring-emerald-500 focus:border-emerald-500 w-full sm:w-96"
                required autofocus autocomplete="provincia" placeholder="Provincia" maxlength="50" pattern="^([a-zA-ZáéíóúÁÉÍÓÚñÑ]+\s?)+"
        ...
        <div class="mb-2 p-2">
            <div class="flex justify-between">
                <label id="label_instruccion" for="instruccion" class="text-sm font-bold text-white mr-3 w-28 inline-block pb-2">
                    Instrucción:
                </label>
