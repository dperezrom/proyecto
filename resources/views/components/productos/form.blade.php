...
<div class="sm:mx-5 lg:mx-20 bg-emerald-500 p-5 mb-5">
    <div class="bg-gray-700 p-2 rounded-t-xl py-5 border-gray-400 border-b-4">
        ...
        <div x-data="imageViewer('/images/productos/{{ old('imagen', $producto->imagen) ?: 'default.png' }}')"
             class="mb-5 w-full">
            <!-- Mostrar imagen -->
            ...
            <!-- Input imagen -->
            <input name="imagen" id="imagen" type="file" accept="image/png, image/jpeg" @change="fileChosen"
                   class="hidden" value="">
            <input type="hidden" name="eliminarimg" id="eliminarimg" value=""/>

            <div class="flex justify-center items-center space-x-4 pt-3">
                <label for="imagen"
                       class="font-semibold cursor-pointer px-3 py-1 bg-gray-200 hover:bg-gray-300 text-gray-600 rounded-lg">
                    AÑADIR FOTO
                </label>
                <div id="borrar-imagen" @click="imageUrl='/images/productos/default.png';clearImg()"
                     class="bg-red-500 text-white hover:bg-red-700 font-semibold px-3 py-1 rounded-lg cursor-pointer">
        ...
        <div class="mb-2 p-2">
            ...
            <input type="text" name="denominacion" id="denominacion"
                   ...
                   required maxlength="100" value="{{ old('denominacion', $producto->denominacion) }}">
        </div>
        <div>
            @error('denominacion')
            <p class="text-red-500 text-sm mb-5 border-y-4 text-center">
        ...
        <div class="mb-2 p-2">
            ...
            <input type="text" name="precio" id="precio" step="any" min="0" maxlength="7" max="9999"
                   pattern="^[0-9]{0,4}(\.[0-9]{0,2})?$" required
                   class="bg-gray-50 border border-gray-300 text-gray-800 sm:text-sm rounded-md focus:ring-emerald-500 focus:border-emerald-500 w-full sm:w-80"
        ...
        <!-- IVA -->
        <div class="mb-2 p-2">
            <label id="label_impuesto_id" for="impuesto_id" class="text-sm font-bold text-white mr-3 w-28 inline-block">
                IVA:
            </label>
