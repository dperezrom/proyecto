                    ...
                    <div class="flex flex-wrap flex-row">
                        ...
                        <div class="mb-2 w-full sm:w-1/2 sm:px-2 lg:w-1/4">
                            ...
                            <select name="activo" id="activo"
                                class="bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-md focus:ring-emerald-500 focus:border-emerald-500 w-full">
                                <option value='' {{ (request()->query('activo') == '') ? 'selected' : '' }}>-</option>
                                <option value='t' {{ (request()->query('activo') == 't') ? 'selected' : '' }}>Sí</option>
                                <option value='f' {{ (request()->query('activo') == 'f') ? 'selected' : '' }}>No</option>
                            </select>
                        ...
                        <div class="mb-2 w-full sm:w-1/2 sm:px-2 lg:w-1/4">
                            ...
                            <select name="precio_signo" id="precio_signo"
                                ...
                                <option value='=' {{ request()->query('precio_signo') == '=' ? 'selected' : '' }}>=</option>
                                <option value='>' {{ request()->query('precio_signo') == '>' ? 'selected' : '' }}>&gt;</option>
                                <option value='<' {{ request()->query('precio_signo') == '<' ? 'selected' : '' }}>&lt;</option>
                                <option value='>=' {{ request()->query('precio_signo') == '>=' ? 'selected' : '' }}>&gt;=</option>
                                <option value='<=' {{ request()->query('precio_signo') == '<=' ? 'selected' : '' }}>&lt;=</option>
                        ...
                        <div class="mb-2 w-full sm:w-1/2 sm:px-2 lg:w-1/4">
                            ...
                            <select name="stock_signo" id="stock_signo"
                                class="bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-md focus:ring-emerald-500 focus:border-emerald-500 w-20">
                                <option value='=' {{ request()->query('stock_signo') == '=' ? 'selected' : '' }}>=</option>
                                <option value='>' {{ request()->query('stock_signo') == '>' ? 'selected' : '' }}>&gt;</option>
                                <option value='<' {{ request()->query('stock_signo') == '<' ? 'selected' : '' }}>&lt;</option>
                                <option value='>=' {{ request()->query('stock_signo') == '>=' ? 'selected' : '' }}>&gt;=</option>
                                <option value='<=' {{ request()->query('stock_signo') == '<=' ? 'selected' : '' }}>&lt;=</option>
                        ...
                        <div class="mb-2 w-full sm:w-1/2 sm:px-2 lg:w-1/4">
                            ...
                            class="bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-md focus:ring-emerald-500 focus:border-emerald-500 w-20">
                                <option value='=' {{ request()->query('descuento_signo') == '=' ? 'selected' : '' }}>=</option>
                                <option value='>' {{ request()->query('descuento_signo') == '>' ? 'selected' : '' }}>&gt;</option>
                                <option value='<' {{ request()->query('descuento_signo') == '<' ? 'selected' : '' }}>&lt;</option>
                                <option value='>=' {{ request()->query('descuento_signo') == '>=' ? 'selected' : '' }}>&gt;=</option>
                                <option value='<=' {{ request()->query('descuento_signo') == '<=' ? 'selected' : '' }}>&lt;=</option>
            ...
            <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400 border-separate">
                <thead class="text-xs text-white uppercase bg-emerald-950 dark:bg-gray-700 dark:text-gray-400">
                    ...
                    <tr>
                        ...
                        <th scope="col" class="px-6 py-3">
                            <a href="/productos?orden=descripcion{!! $tOrdenDescripcion . $link !!}" class="flex items-center">
                        ...
                        <th scope="col" class="px-6 py-3">
                            <a href="/productos?orden=categoria_id{!! $tOrdenCategoria_id . $link !!}" class="flex items-center">
                                <span>Categoría</span>
                        ...
                        <th scope="col" class="px-6 py-3">
                            <a href="/productos?orden=precio{!! $tOrdenPrecio . $link !!}" class="flex items-center">
                                <span>Precio</span>
